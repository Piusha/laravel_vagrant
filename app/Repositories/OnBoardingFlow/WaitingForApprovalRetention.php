...
class WaitingForApprovalRetention extends OnBoardingFlowRetention  implements OnBoardingFlowRetentionInterface
{


    protected $step = 'Waiting for approval';

    private static $STEP_PERCENTAGE = 99;
    ...
    {
        return $key > WaitingForApprovalRetention::$STEP_PERCENTAGE and $key <= 100;
    }
